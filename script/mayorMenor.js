...
boton.addEventListener("click", function () {
    ...
    if (e1.value == "" || e2.value == "" || e3.value == "" || e1.value < 0 || e2.value < 0 || e3.value < 0) {
    ...
    if (error) {
        ...
        else if (+e1.value == +e2.value || +e1.value == +e3.value || +e2.value == +e3.value) {
            mC.innerHTML = `No puede haber edades iguales`;
        }
